...
?>
	...
	<form action="./php/actualizar_producto.php" method="POST" class="formularioAjax" autocomplete="off" >
                            ...
                            if($categorias->rowCount()>0){
                                ...
                                foreach($categorias as $categoria){
                                    if($datos['categoria_id'] == $categoria['categoria_id']){
                                        echo'<option value="'.$categoria['categoria_id'].'" selected>'.$categoria['categoria_nombre'].' (Actual)</option>';
                                    }else{
