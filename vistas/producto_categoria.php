    ...
    <div class="columns">
            ...
            <?php
                ...
                if($categorias->rowCount()>0){
                    ...
                    foreach($categorias as $categoria){
                        echo '<a href="http://localhost/inventario/index.php?vista=producto_categoria&categoria_id='.$categoria['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$categoria['categoria_nombre'].'</a>';
                    }
                }else{
        ...
        <div class="column">
            <?php
                ...
                $url = "index.php?vista=producto_categoria&categoria_id=$categoria_id&page=";
                $registros = 15;
                $busqueda = "";
